...
class AssignmentService implements AssignmentServiceContract
{
    ...
    {
        $collection = collect(Assignment::getCanFilterStates());
    ...
    public function complete(Assignment $assignment): bool
    {
        CheckLocation::makeCheck($assignment);
        CheckAssignment::makeSureStateIs(
            $assignment,
            Assignment::WAITING_FOR_RETURNING,
            "You can't complete this assignment"
        );

        $assignment->update(["state_key" => Assignment::COMPLETED]);
    ...
    public function myAssignments($conditions): LengthAwarePaginator
    {
        ...
        $assignments = $this->assignmentModel
            ...
            ->where('assign_date', '<=', Carbon::today())
